...
In order to support loading of multiple wallets in qpaycoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is qpaycoin.cpp.
...
Changes to qpaycoin.cpp
----------------------
qpaycoin.cpp is the entry point into qpaycoin-qt, and as such, will require some minor modifications to provide hooks for
