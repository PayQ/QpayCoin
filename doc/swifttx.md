...
This mechanism has been integrated into Bitcore-Node-QpayCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/QpayCoin-Project/insight-api-qpaycoin#web-socket-api](https://github.com/QpayCoin-Project/insight-api-qpaycoin#web-socket-api) 
* API: [https://github.com/QpayCoin-Project/insight-api-qpaycoin#swifttx-transactions](https://github.com/QpayCoin-Project/insight-api-qpaycoin#swifttx-transactions) 
...
By default, the QpayCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the QpayCoin Core daemon:
