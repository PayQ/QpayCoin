...
bool ProcessBlockFound(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    if (!ProcessNewBlock(state, NULL, pblock))
        return error("QpayCoinMiner : ProcessNewBlock, block not accepted");
...
{
    LogPrintf("QpayCoinMiner started\n");
    ...
    while (fGenerateBitcoins || fProofOfStake) {
        ...
        LogPrintf("Running QpayCoinMiner with %u transactions in block (%u bytes)\n", pblock->vtx.size(),
