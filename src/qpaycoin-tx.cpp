...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Qpaycoin Core qpaycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  qpaycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded qpaycoin transaction") + "\n" +
                               "  qpaycoin-tx [options] -create [commands]   " + _("Create hex-encoded qpaycoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded qpaycoin transaction
