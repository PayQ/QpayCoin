                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("QpayCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and qpaycoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About QpayCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about QpayCoin Core"));
    ...
    openAction->setStatusTip(tr("Open a QpayCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the QpayCoin Core help message to get a list with possible QpayCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("QpayCoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("QpayCoin Core"); // default title
