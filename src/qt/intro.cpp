...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("QpayCoin Core"),
     ...
     * override -datadir in the qpaycoin.conf file in the default data directory
     * (to be consistent with qpaycoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
